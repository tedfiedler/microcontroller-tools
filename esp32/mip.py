"""Tool 8: install MicroPython packages on the device via mip.
...
``esp32 wifi <SSID> --persist`` once to create it. If it isn't present,
...
def run(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        print(f"esp32 mip: {exc}", file=sys.stderr)
        return 1
    return 0
